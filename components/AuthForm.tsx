        ...
        <header className="flex flex-col gap-5 md:gap-8">
            <Link href='/' className='cursor-pointer flex items-center gap-1'>
                <Image 
                    ...
                    alt='FinServe logo'
                />
                <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">FinServe</h1>
            </Link>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        {type === 'sign-up' && (
                            <>
                                ...
                                <div className='flex gap-4'>
                                    <CustomInput 
                                        control={form.control} name='state' label='State' placeholder='eg. Kampala'
                                    />
                                    <CustomInput 
                                        control={form.control} name='postalCode' label='Postal Code' placeholder='eg. 1108'
                                    />
                                </div>
                                <div className='flex gap-4'>
                                    <CustomInput 
                                    ...
                                    />
                                    <CustomInput 
                                        control={form.control} name='ssn' label='SSN' placeholder='Enter your social security number'
                                    />
                                </div>
                            </>
                        )}
